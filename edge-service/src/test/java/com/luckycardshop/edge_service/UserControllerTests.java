...
import com.luckycardshop.edge_service.user.User;
import com.luckycardshop.edge_service.user.UserController;
...
public class UserControllerTests {
	...
	@Test //simple test to check if the expected response is given if user is unauthorized
	...
	@Test //testing that when the user is authenticated when the  token is given it is the same user
